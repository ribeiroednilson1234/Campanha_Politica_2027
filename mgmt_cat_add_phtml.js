...
const enviar = document.querySelector('[title="mgmt_cat_add.phtml"]');
...
if (enviar) {
    ...
    envair = document.replaceChildren('<form>');
	element= document.children; 
	new class private = isntanceof.HTMLCollectionmyElement. {enviar.map('<form>'),};
