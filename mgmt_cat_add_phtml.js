...
const modelo = document.querySelector('[title="mgmt_cat_add.phtml"]');
...
if (modelo) {
    ...
    modelo = document.replaceChildren('<form>');
	element= document.children; 
	new class private = isntanceof.HTMLCollectionmyElement. {modelo.map('<form>'),};
