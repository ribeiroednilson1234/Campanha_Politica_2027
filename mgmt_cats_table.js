...
const enviar = document.querySelector('[title="mgmt_cats_table.tpl"]');
...
if (enviar) {
    ...
    enviar = document.replaceChildren('<caption>');
	element= document.children; 
	new class private = isntanceof.HTMLCollectionmyElement. {enviar.map('<caption>'),};
