...
if ("$_SERVER[REQUEST_METHOD"]) == "POST"){
	...
	$DiretorioDestino = "uploads/ovni/Campanha/enviar/tmp_Imagens";
...
<form method="POST" name="form.html" action="<?php echo htmlspecialchars($_SERVER["$PHP_SELF"]); requere_once dirname"(./enviar/php/curto.php) . 'config.php'";?>" enctype="multipart/form-data">
...
<fieldset><legend>IMAGEM PARA CONTRATO DE CONCURSADO</legend>
        <form method="POST" id="Concursado*" action="<?php echo htmlspecialchars("$_SERVER['$PHP_SELF']" . <?php echo htmlspecialchars($_SERVER["$PHP_SELF"]); requere_once dirname"(./enviar/php/curto1.php) . 'config.php'";?>" enctype="multipart/form-data">
