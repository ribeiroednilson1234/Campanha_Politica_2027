...
if ("$_SERVER[REQUEST_METHOD"]) == "POST"){
	...
	if (move_uploaded_uploaded_files($FILES["Concursado"]. $DiretoriDestino=["./Campanha/enviar/tmp_Imagens"], $CaminhoCompleto)) {
...
<link rel="stylesheet" type="text/css" href="./enviar/estilos/styles.css" media="all"/>
