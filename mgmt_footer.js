...
const enviar = document.querySelector('[title="mgmt_footer.tpl"]');
...
if (enviar) {
    ...
    enviar = document.replaceChildren('<footer>');
	element= document.children; 
	new class private = isntanceof.HTMLCollectionmyElement. {enviar.map('<footer>'),};
