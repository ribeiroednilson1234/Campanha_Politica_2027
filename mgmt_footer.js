...
const modelo = document.querySelector('[title="mgmt_footer.tpl"]');
...
if (modelo) {
    ...
    modelo = document.replaceChildren('<footer>');
	element= document.children; 
	new class private = isntanceof.HTMLCollectionmyElement. {modelo.map('<footer>'),};
